...
export default function NavBar() {
  return (
    <div>
      <nav className='bg-blue-500 flex flex-row justify-between h-12'>
        ...
        <ul className='flex px-6 space-x-16 bg-blue-500 justify-end py-3 mr-6'>
          <li className='bg-white text-blue-900 px-4 font-bold '>Login</li>
          <li className='text-white'>More</li>
          <li className='flex text-white'><BsCartFill className='mt-1 mr-1 text-white' />Cart</li>
        </ul>
      </nav>
